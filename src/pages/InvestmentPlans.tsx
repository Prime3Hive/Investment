      ...
      <div className="min-h-screen flex items-center justify-center py-12 px-4">
        <div className="max-w-md w-full bg-slate-800 rounded-lg p-8 border border-slate-700 text-center">
          ...
          <p className="text-slate-400 mb-6">
            Your investment has been activated and is now earning returns.
          </p>
              ...
              <div>
                ...
                <div className="p-4 bg-slate-700 rounded-lg">
                  ...
                  <p className="text-slate-400 text-sm">
                    {investmentPlans.find(p => p.id === selectedPlan)?.roi}% ROI in{' '}
                    {investmentPlans.find(p => p.id === selectedPlan)?.duration} hours
                  </p>
                </div>
              </div>
                    ...
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-green-400">
                        ${calculateProfit(parseFloat(investmentAmount || '0'), 
                          investmentPlans.find(p => p.id === selectedPlan)?.roi || 0).toLocaleString()}
                      </span>
                    </div>
