/*
  ...
  This migration sets up the complete database schema for the investment platform,
  including all tables, policies, functions, and default data.
  
  ## Tables Created:
  1. profiles - User profile information and wallet addresses
  2. investment_plans - Available investment plans with ROI and duration
  3. investments - User investments tracking
  4. deposit_requests - Deposit confirmation requests
  5. withdrawal_requests - Withdrawal requests
  6. transactions - All financial transactions
  
  ## Security:
  - Row Level Security (RLS) enabled on all tables
  - Policies for user data isolation and admin access
