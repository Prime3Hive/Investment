/*
  ...
  1. Database Constraints
    ...
    - Add positive amount constraints for financial tables
    
  2. Performance Indexes
    - Add composite indexes for common query patterns
    - Add conditional indexes for better performance
    
  3. Security Functions
    - Admin status validation function
    - Secure balance update function with audit trail
  ...
  5. Rate Limiting
    - Rate limits table and functions
...
ALTER TABLE withdrawal_requests ADD CONSTRAINT IF NOT EXISTS check_withdrawal_amount_positive CHECK (amount > 0);
